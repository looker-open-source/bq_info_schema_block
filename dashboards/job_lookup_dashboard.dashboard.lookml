- dashboard: job_lookup_dashboard
  ...
  - title: Job Stages
    ...
    fields: [jobs_by_organization_raw__job_stages.name, jobs_by_organization_raw__job_stages.total_slot_ms,
      jobs_by_organization_raw__job_stages.total_shuffle_output_bytes]
    sorts: [jobs_by_organization_raw__job_stages.total_slot_ms desc]
    limit: 500
    ...
    series_cell_visualizations:
      jobs_by_organization_raw__job_stages.total_slot_ms:
        is_active: true
      jobs_by_organization_raw__job_stages.total_shuffle_output_bytes:
        is_active: true
        value_display: true
